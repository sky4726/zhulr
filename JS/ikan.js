...
try {
	...
	VOD.vod_list = pdfh(html1, ".line-name&&Text");
	VOD.vod_remarks = "";
	VOD.vod_director = "";
	VOD.vod_content = "";
	log(VOD);
...
var rule = {
    ...
    // 榜单执行
    let data = {'billboard': [{'key': 'tag', 'name': '标签', 'value': value}]};
    console.log(JSON.stringify(data));
    //剧集执行:
	...
	搜索:'.col-md-8&&.media;h5&&a&&Text;a&&img&&data-src;a&&href',//第三个是描述，一般显示更新或者完结
}