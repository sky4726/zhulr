var rule={
    ...
    二级:{
        ...
        "desc": ".moviedteail_list li:eq(10) a&&Text;.moviedteail_list li:eq(2)&&Text;.moviedteail_list li:eq(1) a&&Text;.moviedteail_list li:eq(7)&&Text;.moviedteail_list li:eq(5)&&Text",
