{
    ...
    "首页片单是否Jsoup写法": "1",
    "分类起始页码": "1",
    "分类链接": "http://tvfan.xxooo.cf/index.php/vodshow/{cateId}--{by}------{catePg}---{year}.html",
    "分类名称": "自营电影&自营剧集&动漫&综艺&音乐",
    "分类名称替换词": "1&20&24&28&32",
    //"筛选数据": {},
    "筛选数据": "ext",
    //{cateId}
    "筛选子分类名称": "站长推荐电影&动作犯罪&剧情喜剧&科幻神话&恐怖悬疑&战争军事||站长推荐剧集&欧美剧&国产剧&日韩剧&港台剧||站长推荐动漫&国产动漫&日韩动漫&欧美动漫",
    "筛选子分类替换词": "35&6&7&30&29&12||33&22&21&23&31||36&25&26&27",
    //{class}
    "筛选类型名称": "",
    "筛选类型替换词": "*",
    //{area}
    ...
    "分类片单链接加前缀": "http://tvfan.xxooo.cf",
    "分类片单链接加后缀": "",
    "搜索请求头参数": "User-Agent$MOBILE_UA",
    "搜索链接": "http://tvfan.xxooo.cf/index.php/vodsearch/{wd}-------------.html",
    "POST请求数据": "",
    "搜索截取模式": "1",
