var rule = {
    ...
    desc:'data.score;data.year.title;data.area.title;data.actors[0].name;data.actors[1].name;data.actors[2].name;data.actors[3].name;data.actors[4].name;data.actors[5].name;data.directors[*].name',
    img:'data.thumbnail',
