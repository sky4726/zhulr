...
var rule = {
	...
	play_parse:true,
	lazy:'js:if(/m3u8|mp4|mkv/.test(input)){input}else if(/TY_4K|TY_4Kyun/.test(input)){let purl=request("http://lflong.lyyytv.cn/json.php?url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
	limit:6,
	推荐:'json:list;vlist;*;*;*;*',
	double: true,
